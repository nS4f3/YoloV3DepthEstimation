...
def plot_one_box(x, im, color=(128, 128, 128), label=None, line_thickness=3,grayimg=None):
    ...
    crop_img = grayimg[c1[1]:c2[1],c1[0]:c2[0]]

    text = label + " : " + str(round(findpix(crop_img))) 
